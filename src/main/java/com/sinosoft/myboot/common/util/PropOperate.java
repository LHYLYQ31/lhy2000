...
public class PropOperate {
    ...
    public PropOperate(String filePath) {
        ...
        this.filterUrlList = new ArrayList<String>();
        this.noFilterUrlList = new ArrayList<String>();
        this.authUrlList = new ArrayList<String>();
        writeCache();
    }

    public PropOperate(File file) {
        this.file = file;
        this.filterUrlList = new ArrayList<String>();
        this.noFilterUrlList = new ArrayList<String>();
        this.authUrlList = new ArrayList<String>();
    ...
    private void getPropUrl(Document doc, String strNodeName, List url) {
