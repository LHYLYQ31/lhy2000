...
public class ParamUtils {
	...
	/**
	 * 从request中得到数值的函数，如果为null，返回默认值
	 * 
	 * @param request
	 *            HttpServletRequest对象
	 * @param param
	...
	/**
	 * 从Session中取到变量的值，如果为null，则返回defaultValue
	 * 
	 * @param session
	 *            HttpSession对象
	 * @param sessionName
	 ...
	 * @return 返回Session值
	 */
	public static String getSession(HttpSession session, String sessionName, String defaultValue) {
		String retStr = "";
		try {
			retStr = session.getAttribute(sessionName).toString();
		} catch (Exception e) {
